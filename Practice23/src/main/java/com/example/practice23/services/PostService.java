...
import com.example.practice23.repositories.PostRepository;
...
public class PostService {
    ...
    /*@Transactional(readOnly = true)
    public Users getUserByPost(int postId) {
        return postRepository.findById(postId).orElseThrow(() ->
                new IllegalStateException("Post with this id notfound")).getUsers();
    }*/
